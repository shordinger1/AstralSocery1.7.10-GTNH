...
public class TileStarlightInfuser extends TileReceiverBase implements IWandInteract, IMultiblockDependantTile {
    ...
    private void updateSkyState() {
        boolean seesSky = MiscUtils.canSeeSky(this.worldObj, this.getPos(), true, this.doesSeeSky);
    ...
    public void writeCustomNBT(NBTTagCompound compound) {
        ...
        if (craftingTask != null) {
            ...
            NBTHelper.setUniqueId(compound, "crafterUUID", craftingTask.getPlayerCraftingUUID());
    ...
    public void onInteract(EntityPlayer playerIn, ItemStack heldItem) {
