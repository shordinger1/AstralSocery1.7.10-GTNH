...
import net.minecraft.util.IWorldNameable;
...
public class TileCelestialGateway extends TileEntityTick implements IMultiblockDependantTile, IWorldNameable {
    ...
    public boolean hasCustomName() {
        return display != null && !(display == null || display.length() <= 0);
    }
    ...
    public IChatComponent getDisplayName() {
        return hasCustomName() ? new ChatComponentText(getName()) : new ChatComponentText("");
    }
