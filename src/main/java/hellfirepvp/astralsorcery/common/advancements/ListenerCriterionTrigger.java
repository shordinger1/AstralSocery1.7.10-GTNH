...
import hellfirepvp.astralsorcery.common.migration.advancements.ICriterionTrigger;
...
public abstract class ListenerCriterionTrigger<T extends ICriterionInstance> implements ICriterionTrigger<T> {
    ...
    public static class Listeners<T extends ICriterionInstance> {
        ...
        public final void trigger(CustomPredicate test) {
    ...
    interface CustomPredicate {
        ...
        boolean test(ICriterionInstance instance);
    }
