...
public class AttributeEvent {
    ...
    @ASMCallHook
    public static BaseAttributeMap markToPlayer(BaseAttributeMap map, EntityLivingBase entity) {
    ...
    @Nullable
    private static EntityLivingBase getEntity(BaseAttributeMap map) {
        if (fAttributeMapEntity != null) {
            try {
    ...
    static {
        Field f = null;
        try {
            f = BaseAttributeMap.class.getDeclaredField("as_entity");
        } catch (Exception exc) {
            f = null;
        } finally {
