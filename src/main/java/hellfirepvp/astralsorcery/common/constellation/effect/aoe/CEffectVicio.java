        ...
        if (modified.isCorrupted()) {
            ...
            for (EntityLivingBase entity : entities) {
                if (entity instanceof EntityPlayerMP) {
                    ...
                    if (pl.theItemInWorldManager.getGameType()
                ...
                foundPlayer = true;
                entity.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 9));
                entity.addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 200, 9));
            }
        } else {
