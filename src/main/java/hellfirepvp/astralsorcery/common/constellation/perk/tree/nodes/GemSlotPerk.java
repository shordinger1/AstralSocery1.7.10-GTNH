...
public interface GemSlotPerk {
    ...
    default public boolean hasItem(EntityPlayer player, Side side, @Nullable NBTTagCompound data) {
        ItemStack stack = getContainedItem(player, side, data);
    ...
    default public void addTooltipInfo(Collection<String> tooltip) {
        ...
        if ((contained == null || contained.stackSize <= 0)) {
            tooltip.add(EnumChatFormatting.GRAY + I18n.format("perk.info.gem.empty"));
            if (prog.hasPerkEffect((AbstractPerk) this)) {
                tooltip.add(EnumChatFormatting.GRAY + I18n.format("perk.info.gem.content.empty"));
                ...
                boolean has = !ItemUtils
                    ...
                    .isEmpty();
                if (!has) {
                    tooltip.add(EnumChatFormatting.RED + I18n.format("perk.info.gem.content.empty.none"));
                }
            }
        } else {
            tooltip.add(
            ...
            if (prog.hasPerkEffect((AbstractPerk) this)) {
                tooltip.add(EnumChatFormatting.GRAY + I18n.format("perk.info.gem.remove"));
            }
        }
    }
