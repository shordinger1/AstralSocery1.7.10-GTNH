...
public class ActiveInfusionTask {
    ...
    public int getChaliceRequiredAmount() {
        return recipeToCraft.doesConsumeMultiple()
            ? WrapMathHelper.floor(recipeToCraft.getLiquidStarlightConsumptionChance() * 400 * 12)
            : WrapMathHelper.floor(recipeToCraft.getLiquidStarlightConsumptionChance() * 400);
    }
