...
public class StarlightNetworkRegistry {
    ...
    @Nullable
    public static IStarlightBlockHandler getStarlightHandler(World world, BlockPos pos, Block state,
    ...
    public static interface IStarlightBlockHandler {
        ...
        default public boolean isApplicable(World world, BlockPos pos, Block state,
