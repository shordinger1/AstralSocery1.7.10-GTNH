...
import hellfirepvp.astralsorcery.common.init.BlockRegister;
...
public class CommonProxy implements IGuiHandler {
    ...
    public void preInit() {
        // Setup defaults and creative tabs
        ItemRegister.setupDefaults();

        // Direct block registration (TSS-style)
        BlockRegister.registry();

        // Direct item registration (TSS-style)
    ...
    // Capabilities in 1.7.10 use NBT-based storage directly (see AmuletHolderCapability)
    /*
    ...
    public void init() {
        ...
        MinecraftForge.EVENT_BUS.register(hellfirepvp.astralsorcery.common.util.CustomAttributes.INSTANCE);
