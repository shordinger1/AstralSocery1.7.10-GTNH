...
public class TimeStopEffectHelper {
    ...
    public void playClientTickEffect() {
        ...
        int minX = WrapMathHelper.floor((position.getX() - range) / 16.0D);
        int maxX = WrapMathHelper.floor((position.getX() + range) / 16.0D);
        int minZ = WrapMathHelper.floor((position.getZ() - range) / 16.0D);
        int maxZ = WrapMathHelper.floor((position.getZ() + range) / 16.0D);
