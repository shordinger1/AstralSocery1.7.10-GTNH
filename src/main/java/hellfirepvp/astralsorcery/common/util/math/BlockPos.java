package hellfirepvp.astralsorcery.common.util.math;
...
public class BlockPos extends Vec3i {
    ...
    // MathHelper.smallestEncompassingPowerOfTwo(30000000) = 33554432 (2^25)
    // MathHelper.log2(33554432) = 25
    private static final int NUM_X_BITS = 1 + 25; // 26
