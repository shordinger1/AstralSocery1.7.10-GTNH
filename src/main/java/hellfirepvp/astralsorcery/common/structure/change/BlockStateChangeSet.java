...
public final class BlockStateChangeSet {
    ...
    public void addChange(BlockPos pos, Block oldState, Block newState) {
    ...
    public static final class StateChange {
        ...
        public final Block oldState, newState;

        private StateChange(BlockPos pos, Block oldState, Block newState) {
            this.pos = pos;
