...
public class ItemCollectorCrystal extends ItemBlockCustomName implements ItemHighlighted {
    ...
    public Entity createEntity(World world, Entity entity, ItemStack itemstack) {
        ...
        // 1.7.10: Set delayBeforeCanPickup field directly (no setDefaultPickupDelay method)
        ei.delayBeforeCanPickup = 10;
        ei.motionX = entity.motionX;
        ei.motionY = entity.motionY;
        ei.motionZ = entity.motionZ;
        // 1.7.10: getOwner/setOwner and getThrower/setThrower don't exist in EntityItem
        // Thrown item tracking not available in 1.7.10
        return ei;
    }
