...
public class ItemBlockCustomName extends ItemBlock {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        Block b = field_150939_a; // REMOVED: getBlock() - 1.7.10 ItemBlock doesn't have this method
        // Using obfuscated field 'field_150939_a' which is the block field
        if (b instanceof BlockCustomName) {
            // 1.7.10: Use getIdentifierForMeta if available
