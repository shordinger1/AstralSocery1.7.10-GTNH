...
public class PlayerProgress {
    ...
    public void load(NBTTagCompound compound) {
        ...
        if (compound.hasKey("tierReached")) {
            ...
            tierReached = ProgressionTier.values()[WrapMathHelper
    ...
    public List<ResearchProgression> getResearchProgression() {
        Iterator<ResearchProgression> it = researchProgression.iterator();
        while (it.hasNext()) {
            if (it.next() == null) {
                it.remove();
            }
    ...
    protected void receive(PktSyncKnowledge message) {
        ...
        this.tierReached = ProgressionTier.values()[WrapMathHelper
