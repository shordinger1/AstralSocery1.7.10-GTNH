...
public class WorldCacheManager implements ITickHandler {
    ...
    public static enum SaveKey {
        ...
        ROCK_CRYSTAL("rcrystals", new DataProvider<CachedWorldData>() {

            @Override
            public CachedWorldData provideDataInstance() {
                return new RockCrystalBuffer();
            }
        }),
        LIGHT_NETWORK("lightnetwork", new DataProvider<CachedWorldData>() {
        ...
        CHUNK_VERSIONING("chunkversions", new DataProvider<CachedWorldData>() {

            @Override
            public CachedWorldData provideDataInstance() {
                return new ChunkVersionBuffer();
            }
        }),
        GATEWAY_DATA("gateway", new DataProvider<CachedWorldData>() {

            @Override
            public CachedWorldData provideDataInstance() {
                return new GatewayCache();
            }
        }),
        STRUCTURE_GEN("structures", new DataProvider<CachedWorldData>() {

            @Override
            public CachedWorldData provideDataInstance() {
                return new StructureGenBuffer();
            }
        }),
        STORAGE_BUFFER("storagenetwork", new DataProvider<CachedWorldData>() {
        ...
        STRUCTURE_MATCH("structurematcher", new DataProvider<CachedWorldData>() {
