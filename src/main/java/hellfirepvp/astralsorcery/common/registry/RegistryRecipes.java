...
public class RegistryRecipes {
    ...
    private static void initVanilla() {
        ...
        // In 1.7.10, recipes don't need to be registered through primer
        // RecipeChangeWandColor.INSTANCE is used directly in crafting
    ...
    private static void initAltarRecipes() {
        ...
        ArrayList<ItemStack> applicable = new ArrayList<>();
