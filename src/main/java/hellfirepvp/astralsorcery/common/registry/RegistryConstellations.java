...
public class RegistryConstellations {
    ...
    // registerControllerEffect(discidia, () -> new EffectControllerDiscidia());
    // registerControllerEffect(aevitas, () -> new EffectControllerAevitas());
    // }
    ...
    private static void registerMapEffects() {
        ...
        registerMapEffect(
            horologium,
            Arrays.asList(
                new EnchantmentMapEffect(Enchantment.fortune, 4, 6),
                new EnchantmentMapEffect(Enchantment.looting, 3, 5)),
        ...
        registerMapEffect(
            pelotrio,
            Arrays.asList(
                new EnchantmentMapEffect(Enchantment.infinity, 1, 1),
                new EnchantmentMapEffect(Enchantment.field_151369_A, 4, 6)),
            Arrays.asList(
                new PotionMapEffect(Potion.regeneration, 2, 4),
                new PotionMapEffect(Potion.field_76444_x, 1, 4)));

        registerMapEffect(
            gelu,
            Arrays.asList(
                // Frost walker doesn't exist in 1.7.10, using featherFalling instead
                new EnchantmentMapEffect(Enchantment.featherFalling),
                new EnchantmentMapEffect(Enchantment.unbreaking, 2, 4)),
            Arrays.asList(
                new PotionMapEffect(Potion.resistance, 1, 2),
                new PotionMapEffect(Potion.fireResistance, 0, 0),
                new PotionMapEffect(Potion.moveSlowdown, 0, 1)));
        registerMapEffect(
            ulteria,
            Arrays.asList(
                new EnchantmentMapEffect(Enchantment.unbreaking, 2, 3).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.fireProtection, 4, 6).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.blastProtection, 4, 6).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.projectileProtection, 4, 6).setIgnoreCompatibility()),
            Arrays.asList(
                new PotionMapEffect(Potion.resistance, 0, 2),
                new PotionMapEffect(Potion.regeneration, 1, 1),
                new PotionMapEffect(Potion.weakness, 1, 2)));
        registerMapEffect(
            alcara,
            Arrays.asList(
                // SWEEPING edge enchantment doesn't exist in 1.7.10
                new EnchantmentMapEffect(Enchantment.field_151369_A, 2, 5).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.field_151370_z, 3, 6).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.silkTouch, 1, 1)),
            Arrays.asList(
                // Luck potion doesn't exist in 1.7.10
                new PotionMapEffect(Potion.field_76443_y, 2, 4),
                new PotionMapEffect(Potion.invisibility, 0, 1),
                new PotionMapEffect(Potion.hunger, 1, 2)));
        registerMapEffect(
            vorux,
            Arrays.asList(
                new EnchantmentMapEffect(Enchantment.smite, 4, 7).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.baneOfArthropods, 4, 7).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.sharpness, 3, 4).setIgnoreCompatibility(),
                new EnchantmentMapEffect(Enchantment.power, 3, 4).setIgnoreCompatibility()),
            Arrays.asList(
                new PotionMapEffect(Potion.damageBoost, 2, 3),
                new PotionMapEffect(Potion.resistance, 0, 1),
                new PotionMapEffect(Potion.digSlowdown, 1, 3)));
    }
    ...
    private static void registerSignatureItems() {
        ...
        // alcara.addSignatureItem(new ItemHandle(new ItemStack(Items.nether_stalk)));
