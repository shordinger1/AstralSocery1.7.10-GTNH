...
public abstract class ClassPatch {
    ...
    @Nonnull
    public static AbstractInsnNode findFirstInstructionAfter(MethodNode mn, int startIndex, CustomPredicate check) {
    ...
    public static int peekFirstInstructionAfter(MethodNode mn, int startIndex, CustomPredicate check) {
        for (int i = startIndex; i < mn.instructions.size(); i++) {
            AbstractInsnNode ain = mn.instructions.get(i);
