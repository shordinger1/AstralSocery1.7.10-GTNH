...
public class TESRRitualPedestal extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTicks) {
        if (!(te instanceof TileRitualPedestal)) return;
        TileRitualPedestal tile = (TileRitualPedestal) te;
        renderTileRitualPedestal(tile, x, y, z, partialTicks);
    }

    private void renderTileRitualPedestal(TileRitualPedestal te, double x, double y, double z, float partialTicks) {
