...
import hellfirepvp.astralsorcery.common.block.BlockLens;
import hellfirepvp.astralsorcery.common.util.LogHelper;

/**
 * ItemRenderer for Lens
 */
public class LensItemRenderer implements IItemRenderer {
    ...
    public LensItemRenderer(IModelCustom model, ResourceLocation texture) {
        this.model = model;
        this.texture = texture;
        LogHelper.info("[LensItemRenderer] Initialized with model and texture: " + texture);
    }
    ...
    public boolean handleRenderType(ItemStack item, ItemRenderType type) {
        ...
        if (item.getItem() instanceof net.minecraft.item.ItemBlock) {
            ...
            if (itemBlock.field_150939_a instanceof BlockLens) {
                return true;
            }
        }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (this.model != null) {
            ...
            LogHelper.warn("[LensItemRenderer] Model is null, cannot render!");
        }
