...
/**
 * ItemRenderer for Bore
 */
public class BoreItemRenderer implements IItemRenderer {

    private final IModelCustom model;
    private final ResourceLocation texture;

    public BoreItemRenderer(IModelCustom model, ResourceLocation texture) {
        this.model = model;
        this.texture = texture;
        LogHelper.info("[BoreItemRenderer] Initialized with model and texture: " + texture);
    }
    ...
    public boolean handleRenderType(ItemStack item, ItemRenderType type) {
        ...
        if (item.getItem() instanceof net.minecraft.item.ItemBlock) {
            ...
            if (itemBlock.field_150939_a instanceof BlockBore) {
                return true;
            }
        }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (this.model != null) {
            ...
            LogHelper.warn("[BoreItemRenderer] Model is null, cannot render!");
        }
