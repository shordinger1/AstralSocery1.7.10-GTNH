...
/**
 * ItemRenderer for Discovery Altar (basic altar)
 * <p>
 * Note: This is for the Discovery Altar (BlockAltar), not Crafting Altars (Tier 1-4)
 */
public class AltarItemRenderer implements IItemRenderer {
    ...
    public AltarItemRenderer(IModelCustom model, ResourceLocation texture) {
        this.model = model;
        this.texture = texture;
        LogHelper.info("[AltarItemRenderer] Initialized with model and texture: " + texture);
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (this.model != null) {
            ...
            LogHelper.warn("[AltarItemRenderer] Model is null, cannot render!");
        }
