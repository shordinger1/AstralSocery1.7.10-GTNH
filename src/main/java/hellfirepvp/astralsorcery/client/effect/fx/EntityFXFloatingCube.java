...
public class EntityFXFloatingCube extends EntityComplexFX {
    ...
    public EntityFXFloatingCube(Block blockState) {
        // In 1.7.10, getBlockModelShapes() doesn't exist
        // Use block.getIcon(0, 0) directly on the block, cast to TextureAtlasSprite
        this.tas = (TextureAtlasSprite) blockState.getIcon(0, 0);
        this.tex = null;
    }
    ...
    public EntityFXFloatingCube setWorldLightCoord(World iba, BlockPos pos) {
        // In 1.7.10, use blockLightValue and getSkyBlockTypeBrightness directly
        int blockLight = iba.getBlockLightValue(pos.getX(), pos.getY(), pos.getZ());
        int skyLight = iba.getSkyBlockTypeBrightness(EnumSkyBlock.Sky, pos.getX(), pos.getY(), pos.getZ());
        this.lightCoordX = skyLight * 256;
        this.lightCoordY = blockLight * 256;
        return this;
    }
