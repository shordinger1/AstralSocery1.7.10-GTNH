...
public class CompoundEffectSphere extends CompoundObjectEffect {
    ...
    public CompoundEffectSphere(Vector3 centralPoint, Vector3 southNorthAxis, double sphereRadius, int fractionsSplit,
        ...
        fractionsSplit = WrapMathHelper.clamp(fractionsSplit, 2, Integer.MAX_VALUE);
        fractionsCircle = WrapMathHelper.clamp(fractionsCircle, 3, Integer.MAX_VALUE);
