...
public class UIGateway {
    ...
    public void renderIntoWorld(float pticks) {
        ...
        alpha = WrapMathHelper.clamp(alpha, 0F, 1F);
        ...
        RenderingUtils.sortVertexData(tes);
        tes.draw();
    ...
    public void renderGatewayTarget(float pTicks) {
        ...
        if (focusTicks > 50) {
            ...
            perc = WrapMathHelper.clamp(perc, 0.5F, 1F);
        }
        ...
        if (screenshot != null) {
            ...
            Vector3 pos = focusingEntry.relativePos.clone()
                ...
                .add(origin);
            RenderingUtils
                .renderFacingFullQuadVB(tes, pos.getX(), pos.getY(), pos.getZ(), pTicks, 0.4F, 0, 1F, 1F, 1F, perc);
            tes.draw();
        }
    }
