...
public class PositionedLoopSound extends PositionedSoundRecord implements ITickableSound {
    ...
    public PositionedLoopSound(SoundUtils.CategorizedSoundEvent sound, SoundCategory category, float volume,
        float pitch, Vector3 pos) {
        super(sound.getSoundName(), volume, pitch, (float) pos.getX(), (float) pos.getY(), (float) pos.getZ());
    }
