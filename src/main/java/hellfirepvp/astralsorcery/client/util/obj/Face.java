...
public class Face {
    ...
    public void addFaceForRender(Tessellator vb) {
        addFaceForRender(vb, 0.0005F);
    }

    @SideOnly(Side.CLIENT)
    public void addFaceForRender(Tessellator vb, float textureOffset) {
        /*
         * if (faceNormal == null) { faceNormal = this.calculateFaceNormal(); }
