        ...
        if (starRect != null && starRect.contains(mousePoint)) {
            RenderingUtils.renderBlueTooltip(mousePoint.x, mousePoint.y, new LinkedList<>() {

                {
                    ...
                    // 1.7.10: Use GameSettings.getKeyDisplayString(keyCode) instead of keyBinding.getDisplayName()
                    add(
                        I18n.format(
                            "misc.journal.info.2",
                            GameSettings
                                .getKeyDisplayString(Minecraft.getMinecraft().gameSettings.keyBindForward.getKeyCode()),
                            GameSettings
                                .getKeyDisplayString(Minecraft.getMinecraft().gameSettings.keyBindBack.getKeyCode())));
                }
