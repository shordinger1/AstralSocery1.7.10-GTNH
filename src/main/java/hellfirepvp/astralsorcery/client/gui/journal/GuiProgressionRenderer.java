...
public class GuiProgressionRenderer {
    ...
    private void renderCluster(ResearchProgression p, ClientJournalMapping.JournalCluster cluster, double lowerPosX,
        ...
        t.addVertexWithUV(0, height, zLevel, 0, 1);
        t.addVertexWithUV(width, height, zLevel, 1, 1);
        t.addVertexWithUV(width, 0, zLevel, 1, 0);
        t.addVertexWithUV(0, 0, zLevel, 0, 0);
        t.draw();
    ...
    private void drawClusterBackground(BindableResource tex, float zLevel) {
        ...
        tes.addVertexWithUV(realCoordLowerX, realCoordLowerY + realRenderHeight, zLevel, 0, 1);
        tes.addVertexWithUV(realCoordLowerX + realRenderWidth, realCoordLowerY + realRenderHeight, zLevel, 1, 1);
        tes.addVertexWithUV(realCoordLowerX + realRenderWidth, realCoordLowerY, zLevel, 1, 0);
        tes.addVertexWithUV(realCoordLowerX, realCoordLowerY, zLevel, 0, 0);
    ...
    private void drawBlendedStarfieldOverlay(float zLevel, double scalePosX, double scalePosY, double scaleFactor) {
        ...
        Tessellator tes = Tessellator.instance;
        tes.startDrawingQuads();
        tes.addVertexWithUV(0, realRenderHeight, zLevel, lowU, highV);
        tes.addVertexWithUV(realRenderWidth, realRenderHeight, zLevel, highU, highV);
        tes.addVertexWithUV(realRenderWidth, 0, zLevel, highU, lowV);
        tes.addVertexWithUV(0, 0, zLevel, lowU, lowV);
        Tessellator.instance.draw();
        GL11.glPopMatrix();
        GL11.glColor4f(1F, 1F, 1F, 1F);
    }
