    ...
    public static class Render implements IGuiRenderablePage {
        ...
        private List<String> buildLines(String unlocText) {
            ...
            for (String segment : text.split("<NL>")) {
                lines.addAll(RenderingUtils.listFormattedStringToWidth(fontRenderer, segment, DEFAULT_WIDTH));
                lines.add("");
            }
            return lines;
        }
        ...
        public void render(float offsetX, float offsetY, float pTicks, float zLevel, float mouseX, float mouseY) {
            ...
            for (int i = 0; i < lines.size(); i++) {
                ...
                fontRenderer.drawString(line, (int) offsetX, (int) (offsetY + (i * 10)), 0x00DDDDDD);
            }
